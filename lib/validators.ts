...
export const cartItemSchema = z.object({
	...
	variant: z.string().min(1, 'Variant is required'), // variant name (vairant: 'Brown/Medium) (simple: 'simple')
	variantId: z.string().optional().nullable(), // variant id
...
// Matches ProductVariation Table
...
// check attributes: Matches AttributeValue Table
const productAttribute = z.object({
	id: z.string(),
	values: z.array(z.string()), // array of ids
});
...
export const insertProductSchema = z.object({
	...
	attributeValues: z.array(attributeValuesSchema).optional(),
	variants: z.array(productVariationSchema).optional(),
});
